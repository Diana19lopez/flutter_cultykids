...
import 'package:cultykids/src/views/leccion1avanzado.dart';
  ...
  class Leccionb1View extends StatefulWidget{
  @override
  _Leccionb1ViewState createState()=> _Leccionb1ViewState();
}
class _Leccionb1ViewState extends State<Leccionb1View>{
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(  
          ...
          new Image.asset('icons/j1.jpg', width:350.0, height:250.0, //imagen 1
            ),
